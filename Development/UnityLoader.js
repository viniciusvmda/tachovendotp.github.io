...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'teste.data';
    var REMOTE_PACKAGE_BASE = 'teste.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 9008986;
      var PACKAGE_UUID = 'bdad8a03-610c-4b85-a545-567ae8288f18';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 6205519, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(6205519, 6205726, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(6205726, 6209745, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(6209745, 8106389, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(8106389, 8981361, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(8981361, 9008986, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_teste.data');

    };
    Module['addRunDependency']('datafile_teste.data');
